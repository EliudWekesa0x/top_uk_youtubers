...
## Pseudocode
  ...
  3. Load the data into SQL Server or any SQL Editor Tool
...
This is the stage where you have a scan of what's in the data, errors, inconcsistencies, bugs, weird and corrupted characters etc. 
  ...
  - What are my initial observations with this dataset? What's caught my attention so far?
  1. There are at least 4 columns that contain the data needed for this analysis, which signals we have everything we need from the file without needing to contact the client for any more data.
...
| total_videos | INTEGER | NO |
  ...
  1. Remove unnecessary columns by only selecting the ones that we need
...
/*
# Count the total number of records (rows) in the SQL view
*/
...
![Data-type-check](assets/images/3_datatype_check.png)
...
![Power BI-dashboard-snippet](assets/images/top_uk_youtubers_2024.gif)
...
![Youtubers-with-most-subscribers](assets/images/youtubers_with_the_most_subscribers.png)
...
![YouTubers-with-most-videos](assets/images/youtubers_with_the_most_videos.png)
...
![Youtubers-with-most-views](assets/images/youtubers_with_the_most_views.png)
